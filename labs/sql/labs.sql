...
CREATE TABLE `product` (
  ...
  `pproduct` varchar(50) DEFAULT NULL COMMENT '商品名称',
  `ptype` varchar(50) DEFAULT NULL COMMENT '商品类型',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('1', '通信所3', '张三', null, '这是一条备注', '2019-12-03 17:31:28', '2021-03-06 10:18:49', 'TE00000001', 'root', '0');
INSERT INTO `product` VALUES ('2', '通信所', '张三', '1532384234234', '这是一条备注', '2019-12-03 17:48:06', '2019-12-03 17:48:06', 'TE00000001', 'TE00000001', '0');
...
CREATE TABLE `user` (
  ...
  `department` varchar(128) DEFAULT NULL COMMENT '商品',
